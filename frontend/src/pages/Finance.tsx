...
export default function Finance() {
  ...
  return <div className="flex h-full min-h-0 flex-col gap-3 overflow-hidden">
    <header className="shrink-0"><h1 className="text-2xl font-semibold">Thu & Chi</h1><p className="text-xs text-muted-foreground">Sổ dòng tiền tập trung của cửa hàng.</p></header>

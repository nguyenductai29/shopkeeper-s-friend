...
export default function Customers() {
  ...
  return <div className="flex h-full min-h-0 flex-col gap-3 overflow-hidden">
    <header className="shrink-0"><h1 className="font-display text-[26px] font-extrabold leading-tight">Khách hàng</h1><p className="text-xs text-muted-foreground">Theo dõi khách, số đơn, doanh thu và công nợ.</p></header>
